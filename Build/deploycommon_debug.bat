...
robocopy %ExtDir2%\openvdb\bin %OutDir%  *.dll /r:0 >nul
robocopy %ExtDir2%\openvdb\bin\debug %OutDir%  *.dll /r:0 >nul
robocopy %ExtDir2%\gvdb\bin\debug %OutDir%  *.dll /r:0 >nul
robocopy %ExtDir2%\tbb\bin %OutDir%  *.dll /r:0 >nul
robocopy %ExtDir2%\tbb\bin\debug %OutDir%  *.dll /r:0 >nul
robocopy "%~4\Redist\D3D\%2" %OutDir% dxil.dll /r:0 >nul
rem robocopy "%~4\Redist\D3D\%2" %OutDir% dxcompiler.dll /r:0 >nul
