...
bool Sample::init() 
{
	...
	// Load VBX
	char scnpath[1024];		
	if ( !gvdb.getScene()->FindFile ("E:/Graphics/gvdb-voxels/_output/bin/bunny_cloud.vbx", scnpath ) ) {
	...
	cam->setPos(-11.513717, 29.613581, 50.603836);
	cam->setToPos(-11.452119, 29.373362, 49.635075);
...
{
	Sample sample_obj;
	return sample_obj.run ( "NVIDIA(R) GVDB Voxels - gInteractveGL", "intergl", argc, argv, 1920, 1080, 4, 5 );
}
